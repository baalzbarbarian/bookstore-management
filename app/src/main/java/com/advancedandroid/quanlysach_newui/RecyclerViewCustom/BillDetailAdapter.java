...
public class BillDetailAdapter extends RecyclerView.Adapter<BillDetailAdapter.ViewHolder> implements Filterable, View.OnClickListener{
    ...
    public BillDetailAdapter(List<mBillDetail> mUserList, Context context) {
